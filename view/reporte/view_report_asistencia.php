...
<div class="row">
 <div class="col-md-12">
  <div class="tile" style="border-top: 3px solid #0720b7;border-radius: 5px;">
       <h5 class="" style="text-align: center;"><strong>Reporte  Asistencias Municipalidad de Solola -  <?php echo date("Y"); ?></strong></h5>
  ...
  <table id="table_reporte_asistencia" class="display responsive nowrap table table-sm" style="width:100%">
    <thead>
                    <tr>
                        <th>N°</th>
                        <th>ID</th>
